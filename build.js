...
fs.writeFileSync(path.join(root,'index.json'),JSON.stringify({name:'Serenity Zangetsu Sources',description:'Native sources with settings: Anikoto, AnimeKai, AniWave, AnimeGG, CineStream and Videasy. See README for supported features and verification.',sources},null,2)+'\n');

...
- Anime server discovery, direct HLS/MP4 URLs, nested player pages, direct getSources responses, and caption tracks.
...
This is a **0.1.0 experimental port**, not a claim of verified in-app playback. Automated fixture tests check the native contracts and selected parsing/extraction cases. Website availability is a separate check. Phone/TV playback and reading require testing in Zangetsu.

...
The modified `cine-core.js` and generated `serenity-cinestream.js` are distributed under **GPL-3.0-or-later**; see LICENSE-GPL-3.0. Shared Apache-2.0 helpers retain their license and notices within this combined provider. The four pre-existing source bundles and their helpers remain Apache-2.0 (LICENSE).
